...
export function setIsMobileMenu(windowWidth) {
  return {type: 'SETISMOBILEMENU', 'payload' : windowWidth};
}

export function toggleMobileMenuOpen(toggle) {
  return {type: 'TOGGLEMOBILEMENUOPEN', 'payload' : toggle};
}
